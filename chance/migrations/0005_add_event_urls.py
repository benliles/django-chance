...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('chance_event', 'url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.registration_redirect'
        db.add_column('chance_event', 'registration_redirect',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('chance_event', 'url')

        # Deleting field 'Event.registration_redirect'
        db.delete_column('chance_event', 'registration_redirect')
    ...
    models = {
        ...
        'chance.event': {
            ...
            'registration_redirect': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
