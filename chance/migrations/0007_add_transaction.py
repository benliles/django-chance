...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('chance_transaction', (
        ...
        db.send_create_signal('chance', ['Transaction'])

        # Adding M2M table for field registrations on 'Transaction'
        db.create_table('chance_transaction_registrations', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('transaction', models.ForeignKey(orm['chance.transaction'], null=False)),
            ('registration', models.ForeignKey(orm['chance.registration'], null=False))
        ))
        db.create_unique('chance_transaction_registrations', ['transaction_id', 'registration_id'])


    def backwards(self, orm):
        # Deleting model 'Transaction'
        db.delete_table('chance_transaction')

        # Removing M2M table for field registrations on 'Transaction'
        db.delete_table('chance_transaction_registrations')
