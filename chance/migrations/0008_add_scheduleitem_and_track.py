...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('chance_scheduleitem', (
        ...
        db.send_create_signal('chance', ['ScheduleItem'])

        # Adding model 'Track'
        db.create_table('chance_track', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('chance', ['Track'])


    def backwards(self, orm):
        # Deleting model 'ScheduleItem'
        db.delete_table('chance_scheduleitem')

        # Deleting model 'Track'
        db.delete_table('chance_track')
    ...
    models = {
        ...
        'chance.scheduleitem': {
            ...
            'talk': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['chance.Talk']"}),
            'track': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'items'", 'to': "orm['chance.Track']"})
        },
        'chance.talk': {
        ...
        'chance.track': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tracks'", 'to': "orm['chance.Event']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        'chance.transaction': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['auth.User']"}),
            'registrations': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'+'", 'symmetrical': 'False', 'to': "orm['chance.Registration']"})
        },
